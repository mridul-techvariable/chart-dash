...
import { getYAxis } from "../LineChart/bits/yAxis";
...
/**
 * @method MixedChart
 * @description Function to generate a mixed chart
 * @param data
 * @param categories
 * @param options
 * @param onClick
  ...
  useEffect(() => {
    ...
    if (chartData.length) {
      ...
      svg
        ...
        .join("rect")
        .attr("x", (d, index: any): any => x1(index))
        .attr("y", (d) => y(0))
      ...
      console.log("chartDatas", data);

      const line = d3
        .line()
        .x((d, i: any) => {
          const newLocal: any = x0(categories[i]);
          return newLocal + x0.bandwidth() / 2;
        })
        .y((d: any, i) => y0(d));
      ...
      svg
        ...
        .join("g")
        .attr("fill", "#fff")
        .attr("stroke", (d, i: any) => data.color || color(i))
        ...
        // .attr("cx", (d, i) => x0(categories[d.key])+x0.bandwidth()/2)
        .attr("cx", (d: any, i) => {
          const localVal: any = x0(categories[d.key]);
          return localVal + x0.bandwidth() / 2;
        })
        .attr("cy", (d: any, i) => y0(d.value))
        .on("mouseover", function (e, d) {
